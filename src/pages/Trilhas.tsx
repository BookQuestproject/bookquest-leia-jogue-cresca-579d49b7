...
const bookTrails: BookTrail[] = [
  ...
  },
  {
    ...
    cover: "🧩",
    coverImage: "/images/covers/mindset.jpg",
    totalChapters: 10,
    isPremium: false,
    genre: "Não-Ficção",
  ...
  },
  {
    ...
    cover: "🌌",
    coverImage: "/images/covers/breve-historia-tempo.jpg",
    totalChapters: 10,
    isPremium: false,
    genre: "Não-Ficção",
  ...
  },
  {
    ...
    author: "Liev Tolstói",
    cover: "🚂",
    coverImage: "/images/covers/anna-karenina.jpg",
    totalChapters: 20,
    isPremium: true,
    genre: "Romance",
    ...
    return (
      <Layout isPremium={isPremium}>
        <div className="max-w-4xl mx-auto py-8 section-bg-challenges">
          ...
          <div className="relative max-w-md mx-auto py-4 animate-fade-in" style={{ animationDelay: "0.2s" }}>
        ...
        {filteredTrails.length === 0 && (
          <div className="text-center py-16 animate-fade-in">
            ...
            <div className="flex gap-3 justify-center">
              <Link to="/quiz-literario?retake=1">
